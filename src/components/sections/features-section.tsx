...
import { BookOpen, Clock, MessageSquare, Download } from "lucide-react";
...
export function FeaturesSection() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Get insights on presentation quality and clarity with personalized improvement suggestions",
    },
    {
      icon: <BookOpen className="h-6 w-6 text-foreground" />,
      title: "Glossary",
